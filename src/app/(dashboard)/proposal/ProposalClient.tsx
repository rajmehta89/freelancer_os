...
import {
  ...
  Zap, Wrench, Crown, Building2, ChevronDown, KeyRound,
} from "lucide-react";
      ...
      <div className="rounded-2xl border border-white/[0.07] bg-gray-900/40 p-6 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className={cn(
              ...
              "disabled:opacity-50 disabled:cursor-not-allowed border-white/[0.08] hover:border-white/[0.15]"
            )}
          />
          <div className="flex justify-between text-xs text-gray-600">
            <span>{jobPost.length > 0 && jobPost.length < 30 ? "⚠ At least 30 characters needed" : ""}</span>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                disabled={isLoading}
                className="w-full appearance-none rounded-xl border border-white/[0.08] bg-gray-950/60 px-4 py-3 pr-10 text-sm text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
              >
                {PLATFORMS.map((p) => (
        ...
        <div className="flex items-center justify-between gap-4 pt-1">
          ...
          <Button
            ...
            size="lg"
            className="ml-auto shrink-0 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 shadow-lg shadow-indigo-500/20"
          >
      ...
      {(hasOutput || isLoading) && (
        <div className="rounded-2xl border border-white/[0.07] bg-gray-900/40 overflow-hidden">
          ...
          {genState === "complete" && wordCount > 80 && (
            <div className="px-6 py-3 border-t border-white/[0.07] flex justify-end gap-2">
              <Button variant="outline" size="sm" onClick={copyText}>
